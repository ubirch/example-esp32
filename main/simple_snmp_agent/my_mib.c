...
static const struct snmp_scalar_node temperature_node = SNMP_SCALAR_CREATE_NODE_READONLY(1, SNMP_ASN1_TYPE_INTEGER,
                                                                                         get_temperature_value); // ready-only example

/* humidity         .1.3.6.1.4.1.54021.1.2 */
static const struct snmp_scalar_node humidity_node = SNMP_SCALAR_CREATE_NODE_READONLY(2, SNMP_ASN1_TYPE_INTEGER,
                                                                                      get_humidity_value); // ready-only example

/* timestamp        .1.3.6.1.4.1.54021.1.3 */
static const struct snmp_scalar_node timestamp_node = SNMP_SCALAR_CREATE_NODE_READONLY(3, SNMP_ASN1_TYPE_INTEGER,
                                                                                       get_timestamp_value);

/* uuid             .1.3.6.1.4.1.54021.1.4 */
static const struct snmp_scalar_node uuid_node = SNMP_SCALAR_CREATE_NODE_READONLY(4, SNMP_ASN1_TYPE_OCTET_STRING,
                                                                                  get_uuid_value);

/* complete package .1.3.6.1.4.1.54021.1.5 */
static const struct snmp_scalar_node package_node = SNMP_SCALAR_CREATE_NODE_READONLY(5, SNMP_ASN1_TYPE_OCTET_STRING,
                                                                                     get_complete_package);
